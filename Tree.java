...
public class Tree {
    ...
    public static void findLastElement(Tree tree){
        ...
        System.out.println("Максимальное значение в дереве равно: " + Collections.max(dfsOrderItems));
    }
    public static void findFirstElement(Tree tree) {
        ...
        System.out.println("Все элементы дерева: " + dfsOrderItems);
        System.out.println("Минимальное значение в дереве равно: " + Collections.min(dfsOrderItems));
    }
